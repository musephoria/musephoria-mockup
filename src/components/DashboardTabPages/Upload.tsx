import {
  ...
  export default function UploadTab() {
    return (
      <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-5 m-5 rounded-xl h-full">
        <h2 className="text-base font-semibold leading-6 text-gray-100">Projects</h2>
        ...
        <div className="mt-4 flex">
          <a href="#" className="text-sm font-medium text-indigo-100 hover:text-indigo-100">
